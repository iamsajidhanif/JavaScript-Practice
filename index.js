/*
// *************************************************
// Advance JavaScript by Ameen Alam & Daniyal Nagori
// *************************************************
// 1. STRING:
// **********
// String Examples:
...
// Template Literals (Examples I):
// 0. Existing Method:
var myName = "Daniyal";
var greet = "Hello " + myName;
console.log(greet); // Hello Daniyal

// 1. ES6 Method (Template Literals/ Template String):
var myName = "Daniyal";
var greet = `Hello ${myName}`;
console.log(greet); // Hello Daniyal

// 2. Double quotes ("") & Single quotes ('') in Template Literals:
...
Aliquid enim officia exercitationem cupiditate, tenetur ratione?
Incidunt eaque a, officiis enim aliquam odio eum quisquam maxime,
fugiat, inventore natus rerum eligendi.`
...
// Template Literals (Examples II):
// Existing Method:
var user = "Sajid Hanif";
var greet = "Hello " + user + " welcome to 2023";
console.log(greet);
...
// Template Literals with Function (Example):
var fname = "Sajid";
var lname = "Hanif";

var hello = `Hello "${fname} ${lname}" to 'PIAIC'`;
console.log(hello); // Hello "Sajid Hanif" to 'PIAIC'

function fullName(fname, lname) {
    return `${fname} ${lname}`;
}
var hello = `Hello "${fullName(fname, lname)}" to 'PIAIC'`;
console.log(hello); // Hello "Sajid Hanif" to 'PIAIC'
...
if (true) {
    ...
    var userName = 'Ameen Alam'; // userName is still in the Global scope
}
console.log(userName); // output 'Ameen Alam'

// Let & Const: ECMAScript 6 introduced the "let" and "const" keywords:
var userName = 'Ameen Alam';
let age = 20;
...
// Let & Const: "let" and "const" keywords support the declaration of local scope inside block statements:
if (true) {
...
// Variables (var let const) in Block Scope:
if (true) {
    var myAge = 23;
    let cool = true; // Block Scope
    const age = 1; // Block Scope
}
...
chkVar();
console.log(myAge);//Output Uncaught ReferenceError: myAge is not defined
console.log(cool); //Output Uncaught ReferenceError: cool is not defined
console.log(age); //Output Uncaught ReferenceError: age is not defined
...
// Hoisting works with Regular functions only:
sayHi();
...
function sayHi() {
    console.log('hey');
    console.log(add2(1, 2)); // Uncaught TypeError: add2 is not a function
}
...
// 2. Irregular Function:
var sayHi = function () {
    console.log('hey');
}
sayHi();

// 3. Arrow Function (Example #1):
var sayHi = () => { console.log('hey'); }
sayHi();

// 3. Arrow Function (Example #2):
var sayHi = () => {
    console.log('hey');
    console.log('friend');
}
...
// 6. LET VS VAR:
// **************
// The main difference is the scope difference, both are declared as veriable in order to store some value:
var x;
let y;
...
// Task Solution #2 by Zeeshan Hanif:
var numArry = [2, 4, 5, 7];
...
function sum() {
    ...
    var c = a + b; // 13, accessing global variable
    console.log("C " + c);
}
sum();
console.log("A = " + a); // 7
